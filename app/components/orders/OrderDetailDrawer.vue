...
<template>
  ...
  >
    ...
    >
      ...
      >
        <div>
          <h4 class="text-headline-sm font-bold text-on-white">تفاصيل الطلب</h4>
          ...
          <div class="mt-3 space-y-3">
            <button
              @click="
                ...
                if (!showAddPayment && availablePaymentMethods.length) {
                  newPaymentName = availablePaymentMethods[0].name;
                }
              "
